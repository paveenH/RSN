...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr 10 11:07:48 2025
@description:
    Mean NMD for NoRole - NoExpert in diff answer-pairs
...
for task in TASKS:
    try:
        ...
        data_char_filepath = os.path.join(hidden_states_path, f"no_role_{task}_{size}.npy")
