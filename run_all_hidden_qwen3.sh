...
# ==================== All Benchmarks Hidden States Extraction (Qwen3) ====================
# Extract hidden states and answers for Qwen3-8B
# Covers: MMLU-Pro style benchmarks + TruthfulQA
#
# Usage: bash run_all_hidden_qwen3.sh
...
# ==================== Environment ====================
echo "=================================================="
echo "All Benchmarks Hidden States Extraction (Qwen3)"
