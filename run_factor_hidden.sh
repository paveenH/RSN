...
# ==================== Factor Hidden States Extraction ====================
# Extract hidden states and answers for both Llama3 and Mistral
# Dataset: benchmark/factor_mc (MMLU-Pro style)
#
# Usage: bash run_factor_hidden.sh
...
# ==================== Environment ====================
echo "=================================================="
echo "Factor Hidden States Extraction"
...
if [ "${RUN_MISTRAL}" = "true" ]; then
    ...
    if [ $? -ne 0 ]; then
        echo "Mistral extraction failed!"
    fi
fi
